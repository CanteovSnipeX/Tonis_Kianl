        ...
        switch(tipoDeOperaciones){
            ...
            default:
                   if(tblProductos.getSelectionModel().getSelectedItem()!=null){
                    int resultado = JOptionPane.showConfirmDialog(null, "Estas segura de Eliminar el registro?", "Eliminar Producto",JOptionPane. YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
