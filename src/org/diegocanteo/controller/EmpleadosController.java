        ...
        switch(tipoDeOperacion){
            ...
            default:
               if(tblEmpleados.getSelectionModel().getSelectedItem() !=null){
                    int resultado = JOptionPane.showConfirmDialog(null, "Esta seguro de eliminar este registro","Eliminar Empleado",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
